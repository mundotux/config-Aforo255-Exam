...
import com.aforo255.ms.test.transaction.service.ITransactionService;
...
public class TransactionController {
	...
	public ResponseEntity<?> obtenerByInvoiceId(@PathVariable Integer invoiceId){
		
		Iterable<Transaction> iTransaction = transaction.findByIdInvoice(invoiceId); 
